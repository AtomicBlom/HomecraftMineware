        ...
        for (;;)
        {
            ...
            try
            {
                ...
                else if (key.equalsIgnoreCase("f")) // Face Elements: f v1[/vt1][/vn1] ...
                {
                    ...
                    Face face = new Face(va, material.getName());
                ...
                else
                {
                    if (!unknownObjectCommands.contains(key))
                    {
                        ...
                        FMLLog.log.debug("OBJLoader.Parser: command '{}' (model: '{}') is not currently supported, skipping. Line: {} '{}'", key, objFrom, lineNum, currentLine);
                    }
                }
            }
