...
public class GrandDoorStructure extends StructureDefinitionProviderBase
{
    @Override
    public StructureDefinitionBuilder getStructureBuild()
    {
        ...
        builder.setMasterBlock(BlockLibrary.door_grand);
        ...
        builder.setCollisionBoxRule(
                (state) -> state.getValue(BlockProperties.IS_OPEN),
                new float[] {0.0f, 0.0f, 0.0f, pixelWidth * 3.0f, 3.0f, 1.0f}
        );
